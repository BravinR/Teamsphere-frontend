...
const SearchForm = ({ handleSubmitSearch,
                                               searchQuery,
                                               setSearchQuery,
                                               searchResults,handleCreateChat }) => {
            ...
            <div>
                {searchResults.length > 0 ? (
                    searchResults.map((user) => (
                        <UserCard key={user.id} username={user.username} profileImageUrl={user.profile_picture} user_id ={user.id} handleCreateChat={handleCreateChat}/>
                    ))
                ) : (
                    <p></p>
                )}
